...
const RiwayatPemeriksaan = () => {
    const riwayat = [
        ...
        },
        {
            ...
            image: john,
            description:
                "Seorang psikolog berpengalaman dengan 5 tahun dedikasi dalam membantu individu mengatasi berbagai permasalahan psikologis, seperti depresi, gangguan kecemasan, dan identitas seksual..."
        },
        {
            ...
            image: gladies,
            description:
                "Seorang psikolog berpengalaman dengan 5 tahun dedikasi dalam membantu individu dan keluarga mengatasi berbagai permasalahan psikologis, seperti Bipolar, Trauma, Anxiety, Kelu..."
        }
    ]
    ...
    return (
        <div className="p-8 w-full">
            ...
            {data.map((item) => (
                <div
                    key={item.id}
                    className="bg-white w-auto h-40 p-4 mb-4 rounded-lg shadow-md flex items-center justify-between"
                >
                    <div className="flex items-center">
                        <img src={item.url} alt={item.name} className="w-32 h-32 rounded mr-4" />
                        <div className="text-lg">
                            ...
                            <div className="inline-flex justify-normal items-center">
                                ...
                                <p className="text-gray-600">{item.registration_date}</p>
                            </div>{" "}
                            <br />
                            <div className="inline-flex justify-normal items-center">
                                <img src={iconpackage} className="w-5 h-5 mr-2"></img>
                                <p className="text-gray-600">{item.paket}</p>
                            </div>{" "}
                            <br />
                            <div className="inline-flex justify-normal items-center">
                    ...
                    <div className="flex items-center space-x-4">
                        <span
                            className={`px-2 py-1 rounded-full text-white ${
                                item.status === "Berlangsung" ? "bg-[#1572A1]" : "bg-green-500"
                            }`}
                        >
                            {item.status}
                        </span>
