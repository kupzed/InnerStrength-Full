...
const PaymentConfirmation = () => {
    ...
    const handleFinalStep = () => {
        ...
        navigate(`/PembayaranOnline/${dokter_id}`) // Navigate to the new page after final step
    }
    ...
    const stepContent = {
        1: {
            ...
            paragraph2:
                "Dengan melanjutkan, Anda menyetujui pengumpulan, penggunaan, dan pengungkapan informasi Anda sesuai dengan kebijakan privasi kami."
        },
        2: {
            paragraph1: "Pemeriksa Kesehatan Mental",
            paragraph2:
                "Kuesioner ini terdiri dari 10 pertanyaan dan Anda hanya membutuhkan waktu 2-3 menit untuk menyelesaikannya. Semua informasi yang Anda bagikan di sini akan tetap dirahasiakan."
        },
        3: {
        ...
        8: {
            ...
            paragraph2:
                "merasa sangat sedih, kehilangan minat pada aktivitas yang biasanya Anda nikmati, dan sulit untuk merasa senang?"
        },
        9: {
