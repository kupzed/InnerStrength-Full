...
import salingjaga from "../assets/salingjaga.png"
    ...
    return (
        <div>
            ...
            <div className="container mx-auto px-4">
                <h1 className="pt-36 font-bold text-2xl text-center">
                    Temukan, Berdayakan, dan Berkembang Bersama 🌿🌟
                </h1>
                ...
                <div className="pt-14 px-8 md:px-28 flex flex-wrap justify-center items-center gap-4">
                    ...
                    <div className="flex-grow">
                        <div className="px-5 py-2 bg-white text-gray-600 text-left rounded-xl border border-gray-300">
                            Cari Komunitas
                        </div>
                    </div>
                </div>
                ...
                <div className="flex  justify-center pt-2  gap-4">
                    <div className="flex-col items-center flex text-center gap-2 ">
                        <img src={komunitas1} alt="" className="px-2 pt-6  flex-direction justify-center" />
                    </div>
                    <div className="flex-col items-center flex text-center gap-2 ">
                        <Link to="/KomunitasAnda">
                            <img src={komunitas2} alt="" className="px-2 pt-6 flex-direction" />
                        </Link>
                    </div>
                </div>
                ...
                <div className="pt-8 pb-20 grid gap-8 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3">
                    {data.map((rec, index) => (
                        <div
                            key={index}
                            className="flex flex-col items-center justify-center py-10 border-gray-200 rounded shadow-md"
                        >
                            <img src={rec.url} alt="salingjaga" className="w-48 md:w-64 lg:w-80" />
                            <p className="text-gray-300 mt-2">{rec.member_count} Anggota</p>
                            <h1 className="font-bold text-black mt-4 text-start">{rec.title}</h1>
                            <p className="text-center w-8/12 mt-2">"{rec.slogan}"</p>
                            <div className="mt-4">
                                <Link to={`/SalingJaga/${rec.id}`}>
                                    <button className="px-4 lg:px-24 py-2 bg-[#1572A1] hover:bg-blue-500 text-white rounded-md">
                                        Lihat Detail
                                    </button>
                                </Link>
                            </div>
