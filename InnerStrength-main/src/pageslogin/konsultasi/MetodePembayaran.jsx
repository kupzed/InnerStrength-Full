...
const MetodePembayaranDetail = () => {
    ...
    // Effect untuk mengambil metode pembayaran dari local storage
    useEffect(() => {
        const savedMetodePembayaran = JSON.parse(localStorage.getItem("metodePembayaran"))
        if (savedMetodePembayaran) {
            setMetodePembayaran(savedMetodePembayaran)
        }
    }, [])

    // Effect untuk menyimpan metode pembayaran ke local storage
    useEffect(() => {
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 p-4">
                            ...
                            <div>
                                <p className="text-lg mb-2">
                                    Atur pembayaran anda untuk memudahkan memesan terapi di Innerstrength
                                </p>
