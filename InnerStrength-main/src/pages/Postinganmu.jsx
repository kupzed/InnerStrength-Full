...
const Postingan1 = () => {
    ...
    const fetchkomunitas = async () => {
        ...
        try {
            const response = await axios.get(`http://localhost:3001/savedpostsall/${idusers}`)
    ...
    const addpostingan = async () => {
        const formData = new FormData()
        formData.append("community_id", komunitas_id)
        formData.append("title", title)
        formData.append("description", description)
        formData.append("image", file)

        try {
            const response = await axios.post(`http://localhost:3001/communitydata`, formData, {
                headers: {
        ...
        <div className="overflow-hidden">
            ...
            <section id="Bipolar" className="pt-14 px-6 md:px-12 lg:px-20 xl:px-48 pb-28">
                <div className="container mx-auto bg-[#F3F3F3]  rounded-3xl px-24 py-14">
                    <div className="text-3xl font-bold text-[#1572A1] text-start mb-4 pl-12">Buat Postingan</div>
                    ...
                    <div className="mx-auto">
                        ...
                        ></textarea>
                        <div className="flex justify-start pt-1 mb-4">
