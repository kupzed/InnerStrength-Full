...
const DaftarTerapis = () => {
    ...
    const Register = async (e) => {
        ...
        try {
            await axios.post("http://localhost:3001/doctorsregis", {
                name: full_name,
                gender: gender,
        ...
        <div className="flex min-h-screen">
            ...
            <div className="w-full md:w-1/2 flex items-center justify-center p-14 bg-[#1572A1]">
                <div className="max-w-xl w-full space-y-5 border-2 p-10 rounded-lg bg-white">
                    <div>
                        <h2 className="mt-4 text-center text-3xl font-extrabold text-[#008DDA]">Buat Akun Terapis</h2>
                    </div>
