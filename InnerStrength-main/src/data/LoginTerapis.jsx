...
const Login = () => {
    ...
    const Login = async (e) => {
        ...
        if (!email || !password) {
            ...
            try {
                const response = await axios.post("http://localhost:3001/logindoctor", {
                    email: email,
                    password: password
                })
                ...
                localStorage.setItem("iddoctor", doctorId)
            ...
            <div className="w-full md:w-1/2 flex items-center justify-center p-14 bg-[#1572A1]">
                <div className="max-w-xl w-full space-y-5 border-2 p-10 rounded-lg bg-white">
                    <div>
                        ...
                        <h4 className="mt-4 text-center text-1xl font-light text-[#696A6F]">Hi! Welcome Back!</h4>
                    </div>
                    <form className="mt-8 space-y-6">
                        ...
                        <div className="text-center text-sm text-gray-600">
                            Tidak punya akun?{" "}
                            <Link to="/DaftarTerapis " className="font-medium text-[#008DDA] hover:text-[#1572A1]">
                                Daftar
                            </Link>
                        </div>
                    </form>
