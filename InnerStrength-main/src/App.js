        ...
        <div>
            <BrowserRouter>
                <Routes>
                    ...
                    <Route path="/SalingJaga/:komunitas_id" element={<SalingJaga />} />
                    ...
                    <Route path="/Postingan1/:carddata_id" element={<Postingan1 />} />
                    ...
                    <Route path="/Postinganmu/:komunitas_id" element={<Postinganmu />} />
                    <Route path="/DetailKonsultasi/:dokter_id" element={<DetailKonsultasi />} />
                    <Route path="/PesanOnline/:dokter_id" element={<PesanOnline />} />
                    <Route path="/PesanOffline/:dokter_id" element={<PesanOffline />} />
                    <Route path="/PembayaranOnline/:dokter_id" element={<PembayaranOnline />} />
