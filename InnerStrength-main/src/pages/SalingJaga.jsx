...
const cards = [
    {
        ...
        date: "07-05-2024",
        content:
            "Depresi merupakan salah satu gangguan mental yang umum terjadi dan dapat mengurangi kualitas hidup seseorang...",
        link: "/postingan1",
        initialLikes: 12
    },
    {
        ...
        date: "07-05-2024",
        content:
            "Depresi, bagaikan awan kelabu yang menyelimuti jiwa, dapat menguras semangat dan mengganggu kehidupan...",
        link: "/postingan2",
        initialLikes: 8
    },
    {
    ...
    },
    {
        ...
        date: "07-05-2024",
        content:
            "Ada cahaya harapan yang dapat membantu Anda keluar dari keterpurukan: Terapi Perilaku Kognitif (CBT)...",
        link: "/postingan5",
        initialLikes: 3
    },
    {
...
const SalingJaga = () => {
    ...
    const fetchkomunitas = async () => {
        try {
            const response = await axios.get(`http://localhost:3001/communities/${komunitas_id}`)
    ...
    const fetchkomunitasdata = async () => {
        try {
            const response = await axios.get(`http://localhost:3001/communitydata/community/${komunitas_id}`)
            // Assuming the response data structure has a field `url` which is an array of image URLs
    ...
    const [ikuti, setikut] = useState(false)
    ...
    return (
        <div className="overflow-hidden">
            ...
            <div className="px-28 pt-28 mt-9 pd-8">
                <img src={images} className="object-center mx-auto" />
            </div>

            <section id="IsiKomunitas" class="pt-14 px-24 pb-28 text-center">
                <div class=" justify-center">
                    <div class="flex flex-wrap justify-center">
                        <div class="pr-16 pb-12 text-5xl  font-extrabold text-[#1572A1] ">{judul}</div>
                        <div class="mr-7 ml-48 ">
                            <button
                                onClick={handleikuto}
                                id="Ikuti"
                                className="px-2 lg:px-24 h-14 w-72 py-4 text-center flex flex-wrap bg-[#1572A1] hover:bg-blue-500 text-white outline-none rounded-2xl"
                            >
                                {" "}
                                <svg
                            ...
                            >
                                ...
                                >
                                    <g clip-path="url(#clip0_739_4710)">
                                        <path
                                            d="M25.3336 0H6.76685C5.25472 0 3.927 1.24396 3.927 2.7164V30.1823C3.927 30.6751 4.06418 31.0859 4.28527 31.4033C4.54966 31.7827 4.97538 32.0001 5.43189 32C5.8635 32 6.32302 31.8079 6.74738 31.4454L15.0541 24.3926C15.3107 24.1734 15.6792 24.0479 16.0624 24.0479C16.4454 24.0479 16.8132 24.1734 17.0705 24.3932L25.3495 31.4443C25.7753 31.8079 26.2032 32.0002 26.634 32.0002C27.3626 32.0002 28.0728 31.4382 28.0728 30.1824V2.7164C28.0728 1.24396 26.8458 0 25.3336 0Z"
                                            fill="white"
                                        />
                                    </g>
                                    <defs>
                    ...
                    <div className="flex flex-wrap justify-center">
                        {data.map((card, index) => (
                            <CardKomunitas
                                ...
                                link={`/postingan1/${card.id}`}
                                initialLikes={card.likes_count}
                                id={card.id}
                            />
                        ))}
                    </div>
