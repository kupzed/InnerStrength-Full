...
const Header = () => {
    ...
    return (
        <nav
            className={`bg-[#F3F3F3] fixed w-full z-10 ${
                isScrolled ? "bg-[#F3F3F3] bg-opacity-70 backdrop-blur-lg shadow-lg" : "bg-[#F3F3F3]"
            }`}
        >
            ...
            Profile
                    ...
                    <Link to="/MyProfile">
                        <img class="w-7 h-7 rounded-full" src={profileImage} alt="Rounded avatar"></img>
                    </Link>
                </div>
            </div>
            {/* Mobile Menu */}
